...
class Sirket:
    ...
    Lütfen yapmak istediğiniz işlem kodunuz giriniz(1-6): """))
    ...
    def yeniUye(self):
        ...
        dYili = input("Üye doğum tarihi giriniz: ")
    ...
    def uyeCikar(self):
        ...
        while secim < 1 or secim > len(xUyeler):
            secim = int(input("Lütfen (1-{}) arasında bir değer giriniz: ".format(len(xUyeler))))
        uyeler.pop(secim-1)
        sayac = 1
        yUyeler = []
    ...
    def gider(self):
        while True:
            ...
            1-Yeni gider ekle
            2-Çıkış''')
            secim = int(input("Yeni gider eklemek için 1'e, çıkış için 2'ye basınız."))
            if secim ==1:
                giderTuru = input("Gider türünü yazınız: ")
                giderTutar = int(input("Gider tutarını yazınız: "))
                ...
                secim = int(input("Yanlış seçim yaptınız.\n Yeni gider eklemek için 1'e, çıkış için 2'ye basınız."))
    def kar(self):
